...
const debug = debugBuilder('eslint-plugin-vue-i18n-ex:valid-message-syntax')
...
export = createRule({
  meta: {
    ...
    docs: {
      ...
      url: 'https://eslint-plugin-vue-i18n-ex.intlify.dev/rules/valid-message-syntax.html',
      recommended: true
    },
    fixable: null,
    schema: [
